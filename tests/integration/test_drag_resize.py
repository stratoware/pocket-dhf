...
class TestDragResize:
    ...
    def test_browse_page_contains_drag_state_management(self, app, client):
        ...
        assert 'isDragging' in html_content or 'drag' in html_content.lower() or 'resize' in html_content.lower()
    ...
    def test_browse_page_contains_event_cleanup(self, app, client):
        ...
        assert 'removeEventListener' in html_content or 'addEventListener' in html_content
    ...
    def test_browse_page_contains_resize_performance(self, app, client):
        ...
        assert 'requestAnimationFrame' in html_content or 'performance' in html_content.lower() or 'resize' in html_content.lower()
    ...
    def test_browse_page_contains_resize_accessibility(self, app, client):
        ...
        assert 'aria-' in html_content or 'role=' in html_content or 'tabindex=' in html_content
    ...
    def test_browse_page_contains_resize_error_handling(self, app, client):
        ...
        assert 'try' in html_content or 'catch' in html_content or 'error' in html_content.lower()
